...
### Резервирование СУБД
Будем использовать репликацию данных master-slave в PostgreSQL для обеспечения отказоустойчивости.  
Для хранилищ медиафайлов будем использовать multi-region репликацию на основе своего решения, т.к. в предыдущих пунктах был сделан вывод, что выгоднее использовать кастомное решение.
