...
#### Чтение:
Основная нагрузка на чтение приходится на просмотр страницы магазина (1197 RPS в пиковые моменты), просмотр профилей пользователей (598,5 RPS) и загрузку скриншотов (169,5 RPS).
